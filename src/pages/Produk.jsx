...
const Produk = () => {
  return (
    <div className="p-6 max-w-6xl mx-auto font-poppins">
      {/* SEO Metadata */}
      <Helmet>
        <title>Produk Hidroponik Segar | Hummatech</title>
        <meta
          name="description"
          content="Temukan berbagai sayuran hidroponik segar seperti lettuce, kale, bayam, pakcoy, dan lainnya. Dikirim langsung dari kebun ke rumah Anda!"
        />
        <meta property="og:title" content="Produk Hidroponik Segar | Hummatech" />
        <meta property="og:description" content="Sayuran hidroponik segar dan sehat siap antar ke rumah kamu." />
        <meta property="og:image" content="/assets/produk/lettuce.jpg" />
      </Helmet>
