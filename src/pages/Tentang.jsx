...
const Tentang = () => {
  return (
    <> {/* Menggunakan React.Fragment karena ada Helmet */}
      {/* Helmet untuk SEO Metadata */}
      <Helmet>
        ...
        />
        {/* Ganti dengan URL halaman Tentang Anda yang sebenarnya saat deployment */}
        ...
        {/* Ganti dengan URL absolut gambar yang relevan untuk thumbnail sosial media saat deployment */}
        ...
        {/* Ganti dengan URL absolut gambar yang relevan untuk thumbnail Twitter saat deployment */}
        <meta name="twitter:image" content="https://www.yourdomain.com/assets/tentang.jpg" />

        {/* Schema Markup untuk halaman Tentang (Organisation atau AboutPage) */}
      ...
      <div className="p-4 sm:p-6 max-w-6xl mx-auto font-poppins text-gray-800">
        ...
        {/* Perubahan di sini: Mengubah py-4 sm:py-6 menjadi pt-0 pb-4 sm:pt-0 sm:pb-6 */}
        ...
        <hr className="border-t-2 border-green-200 my-10 sm:my-12" />
        ...
        <div className="mt-8 sm:mt-12 text-center text-sm sm:text-md text-gray-600 italic">
